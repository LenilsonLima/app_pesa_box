...
const ConfigurarWifiRaspberry = () => {
    ...
    const handleGravarCaixa = async () => {
        ...
        try {
            ...
            const response = await axios.post(ApiUrl.urlConectarCaixaWifi, body, requestOptions);
            ...
            Alert.alert('SUCESSO', response?.data.retorno.mensagem, [{ text: 'voltar ao inicio', onPress: () => navigation.navigate('Home') }]);
        } catch (error) {
