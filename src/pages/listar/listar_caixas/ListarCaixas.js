...
const ListarCaixas = () => {
    ...
    const requestCaixas = async () => {
        ...
        try {
            const response = await axios.get(`${ApiUrl.urlCaixa}/filtro`, requestOptions);
    ...
    return (
        ...
        >
            {loading || !fontsLoaded ?
                ...
                :
                <>
                    <HeaderComponent icone="close" funcao={() => navigation.goBack()} />
                    {caixas.length > 0 ?
                        ...
                        <View style={styles.opcoesContainer}>
                            ...
                            <View style={styles.opcoesBotoesContainer}>
                                ...
                                <TouchableOpacity style={styles.opcoesLabelWrapper}
                                    onPress={() => {
                                        handleCloseOpcoes();
                                        navigation.navigate("ConfigurarWifiRaspberry", { caixa: {} });
                                    }}
                                >
                            ...
                            <View style={styles.opcoesBotoesContainer}>
                                <TouchableOpacity style={styles.opcoesLabelWrapper}
                                    onPress={() => {
                                        ...
                                        navigation.navigate("GraficoPesos", { caixa: caixaClicada });
                                    }}
                                >
                                ...
                                <TouchableOpacity style={styles.opcoesLabelWrapper}
                                    onPress={() => {
                                        setOpenCloseDadosAndOpcoes(false);
                                        handleConfiguracoesRede(caixaClicada, navigation);
                                    }}
                                >
