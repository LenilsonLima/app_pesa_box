...
const Login = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            const response = await axios.post(ApiUrl.urlLogin, body, requestOption);
                            ...
                            <View style={styles.content}>
                                ...
                                <View style={styles.card}>
                                    <View style={styles.cardFooterNoBorder}>
                                        <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate("SolicitarTrocarSenha")}>
